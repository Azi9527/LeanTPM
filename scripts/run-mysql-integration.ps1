...
try {
    ...
    & mvn.cmd '-Dleantpm.build.directory=target-codex' `
        '-Dtest=MySqlMigrationIntegrationTest,EquipmentMySqlIntegrationTest,InspectionMySqlIntegrationTest,MaintenanceMySqlIntegrationTest,OeeMySqlIntegrationTest,VisualizationMySqlIntegrationTest,MobileMySqlIntegrationTest' test `
